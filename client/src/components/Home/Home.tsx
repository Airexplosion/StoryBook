...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#111111' }}>
      <div className="text-center px-4 md:px-0" style={{ paddingTop: '20px', paddingBottom: '60px' }}>
        <div className="mb-12 md:mb-30 flex justify-center">
          <img src="/SVG/logo.svg" alt="异域故事书·对战" className="w-64 md:w-96 h-auto" />
        </div>
      
        
        <div className="flex flex-row md:flex-row justify-center items-stretch max-w-4xl mx-auto space-x-4 md:space-x-0">
          <Link
            to="/cards"
            className="flex-1 p-4 md:p-8 transition-all duration-300 text-center group"
          >
            <div className="mb-2 md:mb-4 flex justify-center">
              <svg className="w-12 h-12 md:w-16 md:h-16 transition-colors duration-300 group-hover:fill-[#FBFBFB]" viewBox="0 0 1024 1024" fill="#AEAEAE">
            ...
            <h3 className="text-sm md:text-2xl font-bold mb-1 md:mb-4 transition-colors duration-300 group-hover:text-[#FBFBFB]" style={{ color: '#AEAEAE', fontFamily: 'QingNiaoHuaGuangYaoTi, sans-serif' }}>卡牌集</h3>
            <p className="hidden md:block text-sm italic" style={{ color: '#AEAEAE' }}>
              浏览和创建各种类型的卡牌，包括故事牌、配角牌和主角牌
            </p>
          </Link>

          {/* 分割线 - 移动端和桌面端都显示30px短线 */}
          <div className="flex items-center justify-center">
            <div className="w-px h-8" style={{ backgroundColor: '#C2B79C' }}></div>
          </div>
          ...
          >
            ...
            <h3 className="text-sm md:text-2xl font-bold mb-1 md:mb-4 transition-colors duration-300 group-hover:text-[#FBFBFB]" style={{ color: '#AEAEAE', fontFamily: 'QingNiaoHuaGuangYaoTi, sans-serif' }}>卡组构建</h3>
            <p className="hidden md:block text-sm italic" style={{ color: '#AEAEAE' }}>
          ...
          >
            ...
            <h3 className="text-sm md:text-2xl font-bold mb-1 md:mb-4 transition-colors duration-300 group-hover:text-[#FBFBFB]" style={{ color: '#AEAEAE', fontFamily: 'QingNiaoHuaGuangYaoTi, sans-serif' }}>对战房间</h3>
            <p className="hidden md:block text-sm italic" style={{ color: '#AEAEAE' }}>
              创建或加入房间，与其他玩家进行实时对战
            </p>
          </Link>
